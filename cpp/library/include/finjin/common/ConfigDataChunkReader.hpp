...
namespace Finjin { namespace Common {
    ...
    class FINJIN_COMMON_LIBRARY_API ConfigDataChunkReader : public DataChunkReader
    {
    public:
        ConfigDataChunkReader(const ConfigDataChunkReader& other) = delete;
        ConfigDataChunkReader& operator = (const ConfigDataChunkReader& other) = delete;

        ConfigDataChunkReader(ConfigDataChunkReader&& other) = delete;
        ConfigDataChunkReader& operator = (ConfigDataChunkReader&& other) = delete;

    public:
        ConfigDataChunkReader();
        ~ConfigDataChunkReader();

        void Create(const Settings& settings, ConfigDataChunkReader* parentSection, Error& error);
    ...
    private:
        ...
        ConfigDocumentReader documentReader;
        ConfigDocumentLine* documentLine;
