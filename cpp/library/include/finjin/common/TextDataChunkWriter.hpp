...
namespace Finjin { namespace Common {
    ...
    class FINJIN_COMMON_LIBRARY_API TextDataChunkWriter : public DataChunkWriter
    {
    public:
        TextDataChunkWriter(const TextDataChunkWriter& other) = delete;
        TextDataChunkWriter& operator = (const TextDataChunkWriter& other) = delete;

        TextDataChunkWriter(TextDataChunkWriter&& other) = delete;
        TextDataChunkWriter& operator = (TextDataChunkWriter&& other) = delete;
