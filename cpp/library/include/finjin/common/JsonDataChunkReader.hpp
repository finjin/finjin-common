...
namespace Finjin { namespace Common {
    ...
    {
    public:
        JsonDataChunkReader(const JsonDataChunkReader& other) = delete;
        JsonDataChunkReader& operator = (const JsonDataChunkReader& other) = delete;

        JsonDataChunkReader(JsonDataChunkReader&& other) = delete;
        JsonDataChunkReader& operator = (JsonDataChunkReader&& other) = delete;
