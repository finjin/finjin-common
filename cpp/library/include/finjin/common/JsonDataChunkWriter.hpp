...
namespace Finjin { namespace Common {
    ...
    {
    public:
        JsonDataChunkWriter(const JsonDataChunkWriter& other) = delete;
        JsonDataChunkWriter& operator = (const JsonDataChunkWriter& other) = delete;

        JsonDataChunkWriter(JsonDataChunkWriter&& other) = delete;
        JsonDataChunkWriter& operator = (JsonDataChunkWriter&& other) = delete;
