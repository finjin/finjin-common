...
namespace Finjin { namespace Common {
    ...
    public:
        ...
        explicit Setting(Args&&... args) : value(std::forward<Args>(args)...) {this->isSet = false;}
    #endif
        ...
        void Reset(const T& defaultValue) {this->value = defaultValue; this->isSet = false;}
         ...
         */
        T& operator = (const T& value) {this->value = value; this->isSet = true; return this->value;}
