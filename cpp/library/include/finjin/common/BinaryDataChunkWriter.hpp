...
namespace Finjin { namespace Common {
    ...
    {
    public:
        BinaryDataChunkWriter(const BinaryDataChunkWriter& other) = delete;
        BinaryDataChunkWriter& operator = (const BinaryDataChunkWriter& other) = delete;

        BinaryDataChunkWriter(BinaryDataChunkWriter&& other) = delete;
        BinaryDataChunkWriter& operator = (BinaryDataChunkWriter&& other) = delete;
